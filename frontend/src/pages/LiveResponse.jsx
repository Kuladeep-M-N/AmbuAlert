  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 min-h-full animate-in fade-in duration-500">
      ...
      <div className="lg:w-[40%] flex flex-col gap-6 overflow-y-auto pr-2 pb-4">
        ...
        {/* ETA Widget */}
        <div className="card bg-white border-l-4 border-l-cyan-500 shadow-md p-6">
        ...
        <div className="card shadow-md bg-white border border-gray-100 p-6 rounded-xl">
          <div className="flex items-center gap-2 mb-4 text-gray-600">
             <div className="w-6 h-6 bg-blue-500 rounded flex items-center justify-center text-white text-xs font-bold">H</div>
             <h3 className="font-bold tracking-widest uppercase text-cyan-600">Hospital Match</h3>
          </div>
          <div className="flex flex-col">
             <span className="text-xl font-black text-gray-800">{hospital.name}</span>
             <span className="text-[10px] text-gray-400 mt-1 uppercase font-black tracking-widest">{hospital.spec} SPECIALIZATION</span>
             
             <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 mt-4 text-sm text-gray-600 italic border-l-4 border-l-cyan-500">
               "{hospital.selectionReason || 'Nearest General Facility AI Match'}"
             </div>

             <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-100">
                <span className="text-[10px] uppercase font-black text-gray-400 tracking-widest">Distance Parameter</span>
                <span className="font-mono font-black text-lg text-gray-800">{hospital.distanceStr || "2.1 km"}</span>
             </div>
          </div>
        </div>

        {/* Vitals Telemetry */}
        <div className="card flex-1 shadow-md border-gray-200 p-6">
        ...
        {isCritical && (
          <div className="card border-orange-200 bg-orange-50 shadow-sm relative overflow-hidden group p-4">
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div>
                <h4 className="font-bold text-orange-800 uppercase tracking-wide text-[10px] tracking-widest mb-1">Smart City Node: Clearance Active</h4>
