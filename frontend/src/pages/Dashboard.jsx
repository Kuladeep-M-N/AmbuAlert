  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in duration-500">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold mb-2 text-gray-800">System Dashboard</h1>
          <p className="text-gray-500 font-medium">AmbuAlert AI Gateway Overview</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          <div key={i} className="card flex items-center gap-4 hover:border-gray-300 hover:shadow-md transition-all">
      ...
      <div className="card h-64 flex flex-col justify-center items-center text-gray-400 border-dashed border-2 border-gray-200 bg-gray-50/50">
